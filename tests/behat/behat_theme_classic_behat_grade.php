...
/**
 * Behat grade related step definition overrides for the BlueSky theme.
 *
...
/**
 * Behat grade overrides for the BlueSky theme.
 *
 * @package    theme_bluesky
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_bluesky_behat_grade extends behat_grade {
