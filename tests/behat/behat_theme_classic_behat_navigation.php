...
/**
 * Navigation step definition overrides for the BlueSky theme.
 *
...
/**
 * Step definitions and overrides to navigate through the navigation tree nodes in the BlueSky theme.
 *
 * @package    theme_bluesky
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_bluesky_behat_navigation extends behat_navigation {
    /**
